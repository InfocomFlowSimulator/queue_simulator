...
class Flow {
    public:
        ...
        void additional_size_coming(size_t size);
        ...
        virtual uint32_t get_hidden_priority(uint32_t seq);
        ...
        std::unordered_set<uint32_t> received_ack_for;
        ...
        std::vector<FlowDataArrival*> dataArrivalEvents;
        double min_data_arrival_time;
        double max_data_arrival_time;

        double min_work_time;

        void recalculateMinWorkTime(Topology* topology);
};
